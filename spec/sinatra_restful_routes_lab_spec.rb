...
describe "Recipe App" do
  ...
  describe "updating a recipe" do
    before do
      ...
      visit "/recipes/#{@cookie.id}/edit" # edited th fill in properties here to match the inputs to my form, as test was failing, NTS: spent far to longer figureing this out
